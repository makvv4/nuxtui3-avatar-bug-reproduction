import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getQuery as getQuery$1, getRequestURL, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/devalue/index.js';
import destr from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/vue/index.mjs';
import { basename } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/pathe/dist/index.mjs';
import { getIcons } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/@iconify/utils/lib/index.mjs';
import { hash } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/ohash/dist/index.mjs';
import { collections } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/.nuxt/nuxt-icon-server-bundle.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/vladislavmakarov/projects/ui3-test-app/node_modules/@unhead/shared/dist/index.mjs';
...
const rootDir = "/Users/vladislavmakarov/projects/ui3-test-app";
...
const _t39bAuY1ia = (function(nitro) {
...
const _yV7Y4W263B = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
...
const serverAssets = [{"baseName":"server","dir":"/Users/vladislavmakarov/projects/ui3-test-app/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/vladislavmakarov/projects/ui3-test-app","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/vladislavmakarov/projects/ui3-test-app/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/vladislavmakarov/projects/ui3-test-app/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/vladislavmakarov/projects/ui3-test-app/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/vladislavmakarov/projects/ui3-test-app/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _IaWLk5 = defineCachedEventHandler(async (event) => {
...
const _lazy_o91Igk = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_o91Igk, lazy: true, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _IaWLk5, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_o91Igk, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_o91Igk, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/vladislavmakarov/projects/ui3-test-app/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/vladislavmakarov/projects/ui3-test-app/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
